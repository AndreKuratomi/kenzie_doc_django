...
<h4>Model</h4>
The patient model has <b>OneToOne</b> relationship the model User and is defined of having both 'is_admin' and 'is_prof' fields set to False. Its specific field is the <b>'register_number'</b>, a random string with 6 letters, one hyphen and 1 number and generated after its registration.
...
<h4>Model</h4>
The professional model has <b>OneToOne</b> relationship the model User and is defined of having only 'is_prof' field set to True. Its specific fields are:<br><br>
